...
export const metadata: Metadata = {
  ...
  description: "Tournament calendar and live beach volleyball results from the FIVB Beach Pro Tour. Follow your country's duos, match by match.",
  ...
  return (
    <html lang="en">
      <body className="bg-[#f8fafc] text-slate-900 min-h-screen flex flex-col antialiased pb-16 md:pb-0">
        {/* One country selection for the whole app: the zone page, the home
            widget, the ticker and the pool tables all read it from here. */}
        <CountryProvider>
          <Navbar />
